#!/bin/bash
# Deploy GMNet to a remote GPU instance from your local machine.
#
# Usage:
...
# The service keeps running in tmux session "gmnet" on the remote.
# Reattach with: ssh <host> -t tmux attach -t gmnet

set -euo pipefail

SERVICE_NAME="gmnet-service"
REPO_URL="https://github.com/alxBO/gmnet-service.git"
TMUX_SESSION="gmnet"
REMOTE_WORKDIR="~"
